#ifndef SOLVE_SEQUENTIAL_AVX512_INCLUDED
#define SOLVE_SEQUENTIAL_AVX512_INCLUDED
...
{
	// AVX512の逐次実行で解く
	class SolveSequentialAvx512 final
	{
	private:
		// 行列の値
	...
	public:
		...
		SolveSequentialAvx512() {}
		SolveSequentialAvx512(const SolveSequentialAvx512&) = delete;
		SolveSequentialAvx512(SolveSequentialAvx512&&) = delete;
		SolveSequentialAvx512& operator=(const SolveSequentialAvx512&) = delete;
		SolveSequentialAvx512& operator=(SolveSequentialAvx512&&) = delete;
