#ifndef SOLVE_SEQUENTIAL_NATIVE_INCLUDED
#define SOLVE_SEQUENTIAL_NATIVE_INCLUDED
...
{
	// 普通に逐次実行で解く
	class SolveSequentialNative final
	{
	private:
		// 疎行列・ベクトル積 y = A x
	...
	public:
		...
		SolveSequentialNative() {}
		SolveSequentialNative(const SolveSequentialNative&) = delete;
		SolveSequentialNative(SolveSequentialNative&&) = delete;
		SolveSequentialNative& operator=(const SolveSequentialNative&) = delete;
		SolveSequentialNative& operator=(SolveSequentialNative&&) = delete;
